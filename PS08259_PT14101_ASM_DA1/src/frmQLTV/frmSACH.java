...
// kiểm tra vai trò : 1 - Quản lý , 2 - Nhân viên
    ...
    private void mitHDSDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mitHDSDActionPerformed
        JOptionPane.showMessageDialog(this, "Vào hệ thống để thực hiện 'Đăng xuất','Đổi mật khẩu'\r\n"
                + "Vào Quản lý để truy cập thông tin Sách, Độc giả , Nhân viên , NXB , Tác giả \r\n"
                + "Vào thống kê để xem Phiếu nhập , Phiếu mượn , Phiếu mượn chi tiết , Phiếu phạt , Thống kê \r\n"
